...
class WeatherControllerTest: DescribeSpec() {

    override fun listeners(): List<TestListener> = listOf(testListener)

    init {

        describe("Get temperatures functionality") {

            it("should call temperature service and return fetched temperatures") {
                ...
                every { weatherService.fetchTemperatures(
            ...
            it("should throw an error because of parameters validation") {
        ...
        describe("Get windspeeds functionality") {

            it("should call windspeed service and return fetched windspeeds") {
                ...
                every { weatherService.fetchWindspeeds(
                    DateTime("2008-09-15T00:00:00Z").toDate(),
        ...
        describe("Get weather functionality") {

            it("should call weather service and return fetched weather list") {
                ...
                every { weatherService.fetchWeather(
